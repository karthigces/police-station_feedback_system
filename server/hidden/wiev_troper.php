...
<div class="col-sm-7">
	...
	<div>
	<p>View Set: <b>Last 1000</b> | <a href="viewall.php">ALL</a></p>
	</div>
<script>
...
echo "<tr><td colspan='28'>Total : $rowcount</td></tr>";
echo "<tr class='info'>
<th>S.No</th>
<th>Station Code</th>
...
$sql = "SELECT * FROM salem_1c2af6696c4c67949752fa8006c4e63d WHERE status=1 ORDER BY sr_no DESC LIMIT 1000";
	$result = $con->query($sql);
echo "<table class='table table-bordered table-hover'>";
echo "<tr><td colspan='27'>Total : $rowcount</td></tr>";
echo "<tr class='info'>
<th>S.No</th>
<th>Station Code</th>
<th>Petition Number</th>
