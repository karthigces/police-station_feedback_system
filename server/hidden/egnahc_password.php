...
$sql = "UPDATE salem_21232f297a57a5a743894a0e4a801fc3 SET admin_pass=:new_password WHERE admin_code=:admin_code";
$db->prepare($sql)->execute($data);
echo "<div align='center' class='alert alert-info'>Password Updated!</div>";
}
else {
    echo "<tr>";
