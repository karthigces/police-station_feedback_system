...
<link rel="stylesheet" href="../css/bootstrap.min.css">
  ...
  <script src="../js/bootstrap.min.js"></script>
    ...
    <meta name="author" content="GOVERMENT COLLEGE OF ENGINEERING, SALEM">
    ...
    <div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <span class="visible-xs navbar-brand"><?php echo $admin_user. " Police Zone";?></span>
        </div>
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          <ul class="nav navbar-nav">
            <br><li><center><font color="green">Terminal ID : <?php echo $admin_user;?></font></li><br>
			...
			<li class="<?= ($activePage == 'detadilosnoc_troper') ? 'active':''; ?>"><a href="detadilosnoc_troper.php">Consolidated Reports&nbsp;&nbsp;&nbsp;</a></li>
			<li class="<?= ($activePage == 'yliad_troper') ? 'active':''; ?>"><a href="yliad_troper.php">Printable Reports&nbsp;&nbsp;&nbsp;</a></li>
			<li class="<?= ($activePage == 'sevihcra') ? 'active':''; ?>"><a href="sevihcra.php">Monthly Archives&nbsp;&nbsp;&nbsp;</a></li>
			<li class="<?= ($activePage == 'lla_noitats_ssap') ? 'active':''; ?>"><a href="lla_noitats_ssap.php">All Station Passwords&nbsp;&nbsp;&nbsp;</a></li>
			<li class="<?= ($activePage == 'egnahc_password') ? 'active':''; ?>"><a href="egnahc_password.php">Change Password&nbsp;&nbsp;&nbsp;</a></li>
			<li class="<?= ($activePage == 'pukcab') ? 'active':''; ?>"><a href="pukcab.php">Backup&nbsp;&nbsp;&nbsp;</a></li>
